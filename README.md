...
滴答之间，精准触发。Tick 是一个面向 AI Agent 场景的秒级定时触发平台，支持 Cron、固定间隔、一次性定时三种调度类型，提供 CLI-first 的交互体验和完整的 Web 管理界面。
...
![注册](resources/register.png)
![登录](resources/login.png)
![SaaS 架构](resources/Saas.png)
![Dashboard](resources/home.png)
...
- **Web 管理界面**：完整的 Dashboard，支持任务管理、执行历史查看、用户管理、系统设置
- **多方式认证**：支持邮箱密码注册登录和 Microsoft OAuth 单点登录
